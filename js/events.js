// events.js — Pointer interaction: tap-to-wire, long-press move/delete, pinch-zoom, toolbar bindings
  ...
  function openDropdownAt(menuEl, btnEl){
  ...
  document.getElementById('csimParts').onclick = (e)=>{
    e.stopPropagation();
    const menu = document.getElementById('csimPartsMenu');
    if(menu.classList.contains('open')){ menu.classList.remove('open'); return; }
    document.getElementById('csimTemplatesMenu').classList.remove('open');
    openDropdownAt(menu, e.currentTarget);
  };
  ...
  root.addEventListener('click', (e)=>{
    if(!e.target.closest('.csim-wrap-rel') && !e.target.closest('.csim-dropdown')){
      document.getElementById('csimPartsMenu').classList.remove('open');
      document.getElementById('csimTemplatesMenu').classList.remove('open');
    }
  });
  ...
  document.getElementById('csimSidebarToggle').onclick = ()=>{
    document.getElementById('csimSidebarToggle').classList.toggle('collapsed');
    document.getElementById('csimSidebarGroup').classList.toggle('collapsed');
  };
